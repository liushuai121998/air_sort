...
let cloneData = JSON.parse(JSON.stringify(data))
    ...
    //     ]
let thLeftData = thLeftData = [{ title: '-', width: '4%' }, { title: '月/日', width: '4%' }, { title: '标记', width: '4%' }, { title: '主航班号', width: '4%' },
        ...
        { title: '计离', width: '4.5%' }, { title: '预离', width: '4%' }, { title: '实离', width: '4%' }, { title: '预位', width: '4%' }, { title: '跑道', width: '3%' }, { title: '跑道', width: '3%' }, { title: '跑道', width: '3%' }, { title: '跑道', width: '3%' }, { title: '跑道', width: '3%' }, { title: '跑道', width: '3%' }
    ]
    // let thRightData = [
