...
let data = require('../../dataTest.json')
    ...
    // ]
let thLeftData = [{ name: 'index', title: '序号', width: '40px' }, { name: 'flightNo', title: '航班号', width: '102px' }, { name: 'operationDate', title: '月/日', width: '69px' }, { name: 'repeatCount', title: '重复', width: '40px' },
